package com.rahul.fakir.theboldcircle.StoreData.Messaging;
...
import com.rahul.fakir.theboldcircle.UserData.EncodeEmailToUsername;
...
public class StoreChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EncodeEmailToUsername encoder = new EncodeEmailToUsername(email);
        ...
        btnSendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((etMessage.getText().toString().length() != 0) && (storeID.length() * username.length() != 0)) {
                    ...
                    DatabaseReference messageRef = mDatabase.getReference("messaging");
    ...
    private void prepareMessageData() {
        ...
        if (true) {
            messageRef = mDatabase.getReference("messaging").child(storeID).child(username);
